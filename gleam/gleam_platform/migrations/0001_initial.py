...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Organizer',
            fields=[
                ('profile_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='gleam_platform.Profile')),
                ('o_organization', models.CharField(max_length=80, verbose_name='组织')),
            ],
            options={
                'verbose_name': 'Organizer',
            },
            bases=('gleam_platform.profile',),
        ),
        migrations.AddField(
