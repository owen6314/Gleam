# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2017-11-22 06:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tutor', models.CharField(max_length=32, null=True)),
                ('contests', models.ManyToManyField(null=True, to='gleam_platform.Contest')),
                ...
                ('members', models.ManyToManyField(null=True, to='gleam_platform.Contestant')),
            ],
        ),
        migrations.CreateModel(
            name='Tournament',
